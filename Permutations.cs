...
namespace Task1
{
    ...
    class Permutations
    {
        ...
        /// <summary>
        /// Этот метод записывает данный текст, если может, в указанный файл, если не может, в консоль
        /// </summary>
        /// <param name="file">Путь к файлу, в который нужно записывать текст</param>
        ...
        /// <returns>Список непустых строк в тексте (максимум две).</returns>
